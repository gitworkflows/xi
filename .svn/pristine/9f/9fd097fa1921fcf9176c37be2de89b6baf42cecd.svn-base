...
//			SscDataDAO sscDAO=new SscDataDAO();
			...
			try{
				String urlParameters =
			        "track_id=" + URLEncoder.encode(txid, "UTF-8");
...
//		System.out.println(merit_type);
	...
	public String getColleges(){
		...
		HashMap<String, ArrayList<CollegeDTO>> collegeMap=(HashMap<String, ArrayList<CollegeDTO>>)ServletActionContext.getServletContext().getAttribute("ALL_COLLEGE_MAP_OPEN_ADMISSION");
		HashMap<String, ArrayList<CollegeDTO>> collegeMapDist=(HashMap<String, ArrayList<CollegeDTO>>)ServletActionContext.getServletContext().getAttribute("ALL_COLLEGE_MAP_DIST_OPEN_ADMISSION");
...
*/
		...
		{  
			System.out.println("Sorry, you have manipulated your Application Data. We can't accept your application.!!!");
